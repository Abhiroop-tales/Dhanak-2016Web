...
<body>
	...
	<main class="cd-main">
		<section class="cd-section literary visible">

      <main class="cd-3Dmain">
				<header class="literary">
    			<div class="bcg">
						<div class="content">
							<h1>COFFEEHOUSE | LITERARY</h1>
						</div>

					</div>
    		</header>
				<ul class="cd-gallery">
    			<li class="cd-item cat_Lit">
    				<a href="items/just_a_min.php">
    					<div>
							<font color="white">
    						<h2>J.A.M</h2>
    						<p>Just A Minute</p>
    			...
    			<li class="cd-item cat_Lit">
    				<a class="dark-text" href="items/spellBee.php">
    					<div>
							<font color="white">
    						<h2>Spell Bee</h2>
    						<b>View More</b>
    			...
    			<li class="cd-item cat_Lit">
					...
					<li class="cd-item cat_Lit">
    				<a href="items/malExt.php">
    					<div>
							<font color="white">
    						<h2>Uchabhashini</h2>
    						<p>Malayalam Extempore</p>
							<b>View More</b>
							</font>
...
<script>
$("nav.cd-side-navigation ul li#LiteraryLi a").addClass("selected");
</script>
