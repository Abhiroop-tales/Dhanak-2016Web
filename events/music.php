...
<body>
	...
	<main class="cd-main">
		<section class="cd-section music visible">
      ...
      <main class="cd-3Dmain">
				...
				<ul class="cd-gallery">
    			<li class="cd-item cat_Music">
    				<a href="items/duetSinging.php">
    					<div>
							<font color="white">
    						<h2>Raag Milan</h2>
    						<p>Duet Singing</p>
    			...
    			<li class="cd-item cat_Music">
    				<a class="dark-text" href="items/battleBands.php">
    					<div>
							<font color="white">
  ...
  <!-- WIP Modal ends here -->
	...
	<script>
	$("nav.cd-side-navigation ul li#MusicLi a").addClass("selected");
	</script>
