...
<body>
	...
	<main class="cd-main">
		<section class="cd-section online visible">
      ...
      <main class="cd-3Dmain">
				...
				<ul class="cd-gallery">
    			<li class="cd-item cat_online">
    				<a href="items/photography.php">
    					<div>
							<font color="white">
    						<h2>The Picturesque</h2>
    						<p>Photography</p>
							<b>View More</b>
							</font>
       					</div>
    			...
    			<li class="cd-item cat_online">
    				<a href="items/storyWriting.php">
    					<div>
							<font color="white">
    						<h2>The Story In You</h2>
    						<p>Story Writing</p>
    						<b>View More</b>
							</font>
    					</div>
  ...
  <!-- WIP Modal ends here -->
	...
	<script>
	$("nav.cd-side-navigation ul li#OnlineLi a").addClass("selected");
	</script>
